...
[<assembly: AssemblyTitleAttribute("Ascalon.Tests")>]
[<assembly: AssemblyProductAttribute("Ascalon")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Ascalon.Tests"
    let [<Literal>] AssemblyProduct = "Ascalon"
